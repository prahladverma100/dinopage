...
const About_dinol = () => {
    return (
        <div className=' relative bg-[#09655A] z-[2]    '>
            <img className=' right-0 lg:bottom-[-22%] bottom-[-14%] lg:max-w-[300px]  max-w-[200px] w-full absolute z-[10]' src={cartoon} alt="" />
            <img className=' left-0 lg:bottom-[-25%] bottom-[-14%] lg:max-w-[207px] max-w-[120px] w-full absolute z-[10]' src={tree} alt="" />
