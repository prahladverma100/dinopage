...
export function Faq() {
    ...
    return (
        <div className=" overflow-hidden bg-[#0A4740] overflow_hidden relative lg:pb-32 pb-10 md:pb-28" id="FAQ">
            ...
            <h3 className=" ff_chewy font-normal text-white text-5xl lg:text-[64px] leading-[83.63px] text-center lg:pb-[60px] md:pb-10 pb-5 lg:pt-40 md:pt-20 mt-24" data-aos="fade-down"
