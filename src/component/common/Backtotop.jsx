...
function Backtotop() {
    ...
    return (
        <div>
            {backTop ? (<button id='text' onClick={moveToTop} className="transition-all delay-300 fixed  bg-[#FEBF1A]  bottom-0 end-0 me-2 mb-4 animate-bounce  pointer z-10  rounded-[100px]  py-2 px-3">
